...
if(isset($_POST['submit'])){
    ...
    if($conn -> query($sql_qt) === true){
        ...
        echo"<script>alert('เพิ่มหัวข้อคำถามสำเร็จ'); window.location='a_quiz.php';</script>";
    }
}   
?>
<!DOCTYPE html>
...
<body>
<form action="a_quiz.php" method="post">
    <!-- navbar -->
    <div class="bar">
        <div class="myduck">
...
<div class="kontainer_col mtt-5">
       ...
       <div class="bork ">
                ...
                <div class="bork_bork">
                    ...
                    <input hidden type="text" name="qt_type" value ="quiz" class="inside" id="" placeholder="กรุณากรอกข้อมูล..." required>
                </div>
                <!-- ชื่อแบบฟอร์ม -->
            ...
            <!-- card นะจ๊ะ -->
              <!-- card นะจ๊ะ -->
        <?php
        $sql_qt = "SELECT * FROM `p_qtitle` WHERE `qt_type` = 'quiz';";
        ...
        ?>
             <div class="bork ">
                ...
                ?>
                <?php if(empty($row_qs)): ?>
                <a href="a_addquiz.php?qt_id=<?php echo $row_qt['qt_id'] ?>" class="bro fah">📝 เพิ่มคำถาม</a>
                <?php elseif(!empty($row_qs)): ?>
                <a href="a_quizscore.php?qt_id=<?php echo $row_qt['qt_id'] ?>"  class="bro warm">✨ดูคะแนนรวม✨</a>
                <?php endif; ?>
                </div>
            </div>
        <?php endwhile; ?>
