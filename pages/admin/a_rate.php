...
if(isset($_POST['submit'])){
    ...
    if($conn -> query($sql_qt) === true){
        ...
        echo"<script>alert('เพิ่มหัวข้อคำถามสำเร็จ'); window.location='a_rate.php';</script>";
    }
}   
?>
<!DOCTYPE html>
...
<div class="kontainer_col mtt-5">
       ...
       <div class="bork ">
                ...
                <div class="bork_bork">
                    ...
                    <input hidden type="text" name="qt_type" value ="rate" class="inside" id="" placeholder="กรุณากรอกข้อมูล..." required>
                </div>
                <!-- ชื่อแบบฟอร์ม -->
        ...
        ?>
             <div class="bork ">
                ...
                ?>
                <?php if(empty($row_qs)): ?>
                <a href="a_addrate.php?qt_id=<?php echo $row_qt['qt_id'] ?>" class="bro fah">📝 เพิ่มคำถาม</a>
                <?php elseif(!empty($row_qs)): ?>
                <a href="a_ratescore.php?qt_id=<?php echo $row_qt['qt_id'] ?>"  class="bro warm">✨ดูคะแนนรวม✨</a>
                <?php endif; ?>
                </div>
            </div>
        <?php endwhile; ?>
