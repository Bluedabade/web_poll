...
<body>
    <form action="u_dosingle.php" method="post">
           <!-- navbar -->
    <div class="bar">
        <div class="myduck">
    ...
    <!-- navbar -->
        ...
        <!-- ชื่อหัวข้อฟอร์ม -->
        <h4 class="head">ชื่อหัวข้อฟอร์ม</h4>
        <!-- ชื่อหัวข้อฟอร์ม -->
            ...
            <div class="bork ">
                ...
                <!-- คำถาม -->
                <div class="bork_bork">
                    <p>คำถามที่ <?php $i+1 ?> <?php echo $row_qsa['qs_qst'] ?></p>
                </div>
                <!-- คำถาม -->
                <!-- คำตอบ -->
                <div class="bork_bork">
                    ...
                    <p>คำตอบ</p>
                    <input type="text" name="me_ans[]" class="inside" id="" placeholder="กรุณากรอกข้อมูล..." required>
                </div>
                <?php endwhile; ?>
                <!-- คำตอบ -->
 ...
 <div class="bork ">
                ...
                <button type="submit" name="submit"  class="bro fah">✔ เสร็จสิ้น</button>
                    <a href="u_index.php" type="submit" class="bro staw">❌ ยกเลิก</a>
                </div>
                <!-- ปุ่ม 🔽-->
            </div>
            <!-- card นะจ๊ะ -->
